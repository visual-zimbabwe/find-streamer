...
description: >-
  ...
  home-screen design rollout to Search, Discover, Watchlist, Settings, Detail,
  Collections, or other Trova components.
---
...
| File | Role |
|------|------|
| `src/components/HomeScreen.js` | Programme home: featured spotlight, 2-col grids, scroll perf |
...
| Pattern | When |
|---------|------|
| **Featured card** | Single hero item ~45–50% viewport; crossfade rotation |
...
|--------|---------------------|
| **Search** | Editorial search theatre — centered query, visual history as 2-col grid or landscape strips; surprise roulette as Programme modal sheet |
...
- Refined cinematic luxury streaming, seamless with Home
