...
* **Country-by-Country Matrix**: Resolves watch provider data to display exactly which countries host a title on **Netflix**, **Prime Video**, **Max**, Canada-only **CBC Gem**, and UK-only **BBC iPlayer**.
